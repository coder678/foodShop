$(function() {
	...
	var infoUrl = '/foodShop/shopadmin/getproductbyid?productId=' + productId;
	// 获取当前店铺设定的商品类别列表的URL
	var categoryUrl = '/foodShop/shopadmin/getproductcategorylist';
	// 更新商品信息的URL
	var productPostUrl = '/foodShop/shopadmin/modifyproduct';
	// 由于商品添加和编辑使用的是同一个页面，
	// 该标识符用来标明本次是添加还是编辑操作
	var isEdit = false;
	if (productId) {
		...
		//没有的话，只是查看商品的信息
		getCategory();
		productPostUrl = '/foodShop/shopadmin/addproduct';
	}
